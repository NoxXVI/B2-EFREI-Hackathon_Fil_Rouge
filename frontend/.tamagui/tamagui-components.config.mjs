...
function ToastPortal(props) {
  ...
  let content = children;
  return isWeb || (content = /* @__PURE__ */ jsx73(ReprogapateToastProvider, {
    context: context4,
    children
...
var getPanResponder = /* @__PURE__ */ __name(() => isWeb ? null : __require("@tamagui/react-native-web-lite").PanResponder, "getPanResponder");
...
var ToastImpl = React90.forwardRef((props, forwardedRef) => {
  ...
  }), panResponder = React90.useMemo(() => {
    const PanResponder2 = getPanResponder();
    return PanResponder2 ? PanResponder2.create({
